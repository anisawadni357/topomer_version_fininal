...
import { AllpaysService } from 'src/app/services/pays/allpays.service';
...
export class RegisterPage implements OnInit {
  ...
  pays:any=[];
  constructor(private allpaysService:AllpaysService,private router: Router,private profileService:ProfileService,private toastController: ToastController) { }

  ngOnInit() {
    this.allpaysService.getAll()
    .subscribe(
      data => {
       this.pays=data;
